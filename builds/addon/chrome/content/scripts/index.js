...
`;
  ...
  var KeyExampleFactory = class {
    ...
    static exampleShortcutConflictingCallback() {
      ...
      new ztoolkit.ProgressWindow("Check Key Conflicting").createLine({
  ...
  __decorateClass([
    example
  ], KeyExampleFactory, "exampleShortcutLargerCallback", 1);
  __decorateClass([
    example
  ], KeyExampleFactory, "exampleShortcutSmallerCallback", 1);
  __decorateClass([
    example
  ], KeyExampleFactory, "exampleShortcutConflictingCallback", 1);
  var UIExampleFactory = class {
    static registerStyleSheet() {
      ...
      (_a = document.getElementById("zotero-item-pane-content")) == null ? void 0 : _a.classList.add("makeItRed");
    }
    static chatresult(prompt) {
      return __async(this, null, function* () {
        let instr = document.getElementById("zotero-readerpane-__addonRef__-inout").value;
        ...
        const xhr = yield Zotero.HTTP.request(
          "POST",
          apiUrl,
          {
            headers: {
        ...
        if ((xhr == null ? void 0 : xhr.status) !== 200) {
          throw `Request error: ${xhr == null ? void 0 : xhr.status}`;
        }
        let result = xhr.response.choices[0].message.content;
        document.getElementById("zotero-readerpane-__addonRef__-inout").value = result;
      });
    }
    ...
    static registerExtraColumnWithCustomCell() {
      return __async(this, null, function* () {
        yield ztoolkit.ItemTree.register(
          "test2",
          "custom column",
    ...
    static registerCustomCellRenderer() {
      return __async(this, null, function* () {
        yield ztoolkit.ItemTree.addRenderCellHook(
          "title",
          (index, data, column, original) => {
            const span = original(index, data, column);
            span.style.background = "rgb(30, 30, 30)";
            span.style.color = "rgb(156, 220, 240)";
            return span;
          }
        );
        yield ztoolkit.ItemTree.refresh();
      });
    }
    static registerCustomItemBoxRow() {
      return __async(this, null, function* () {
        yield ztoolkit.ItemBox.register(
        ...
        yield ztoolkit.ItemBox.register(
          ...
          (field, unformatted, includeBaseMapped, item, original) => {
            return "[CANNOT EDIT THIS]" + item.getField("title").slice(0, 10);
          },
          {
            editable: false,
            index: 2
    ...
    static registerReaderTabPanel() {
      return __async(this, null, function* () {
        const tabId = yield ztoolkit.ReaderTabPanel.register(
  ...
  __decorateClass([
    example
  ], UIExampleFactory, "registerStyleSheet", 1);
  __decorateClass([
    example
  ], UIExampleFactory, "chatresult", 1);
  __decorateClass([
    example
  ], UIExampleFactory, "registerRightClickMenuItem", 1);
  __decorateClass([
    example
  ], UIExampleFactory, "registerRightClickMenuPopup", 1);
  __decorateClass([
    example
  ], UIExampleFactory, "registerWindowMenuWithSeparator", 1);
  __decorateClass([
    example
  ], UIExampleFactory, "registerExtraColumn", 1);
  __decorateClass([
    example
  ], UIExampleFactory, "registerExtraColumnWithCustomCell", 1);
  __decorateClass([
    example
  ], UIExampleFactory, "registerCustomCellRenderer", 1);
  __decorateClass([
    example
  ], UIExampleFactory, "registerCustomItemBoxRow", 1);
  __decorateClass([
    example
  ], UIExampleFactory, "registerLibraryTabPanel", 1);
  __decorateClass([
    example
  ], UIExampleFactory, "registerReaderTabPanel", 1);
  var PromptExampleFactory = class {
    ...
    static registerAnonymousCommandExample() {
      ztoolkit.Prompt.register([
        {
          id: "search",
          callback: (prompt) => __async(this, null, function* () {
            ...
            function filter(ids2) {
              ids2 = ids2.filter((id) => __async(this, null, function* () {
                const item = yield Zotero.Items.getAsync(id);
...
${items.map(
  ...
  __decorateClass([
    example
  ], PromptExampleFactory, "registerNormalCommandExample", 1);
  __decorateClass([
    example
  ], PromptExampleFactory, "registerAnonymousCommandExample", 1);
  __decorateClass([
    example
  ], PromptExampleFactory, "registerConditionalCommandExample", 1);
  var HelperExampleFactory = class {
    static dialogExample() {
      return __async(this, null, function* () {
        ...
        const dialogHelper = new ztoolkit.Dialog(10, 2).addCell(0, 0, {
          ...
          callback: (e) => {
            var _a;
            (_a = dialogHelper.window) == null ? void 0 : _a.alert(
              "Help Clicked! Dialog will not be closed."
            );
          }
        }).setDialogData(dialogData).open("Dialog Example");
        yield dialogData.unloadLock.promise;
        ztoolkit.getGlobal("alert")(
...
Input: ${dialogData.inputValue}.`
    ...
    static filePickerExample() {
      return __async(this, null, function* () {
        const path = yield new ztoolkit.FilePicker(
          "Import File",
          "open",
          [
            ["PNG File(*.png)", "*.png"],
  ...
  __decorateClass([
    example
  ], HelperExampleFactory, "dialogExample", 1);
  __decorateClass([
    example
  ], HelperExampleFactory, "clipboardExample", 1);
  __decorateClass([
    example
  ], HelperExampleFactory, "filePickerExample", 1);
  __decorateClass([
    example
  ], HelperExampleFactory, "progressWindowExample", 1);
  __decorateClass([
    example
  ], HelperExampleFactory, "vtableExample", 1);
  ...
  function bindPrefEvents() {
    ...
    )) == null ? void 0 : _a.addEventListener("change", (e) => {
      ztoolkit.log(e);
  ...
  function onStartup() {
    return __async(this, null, function* () {
      ...
      yield Zotero.Promise.delay(1e3);
      popupWin.changeLine({
        progress: 30,
      ...
      yield UIExampleFactory.registerExtraColumnWithCustomCell();
      yield UIExampleFactory.registerCustomCellRenderer();
      yield UIExampleFactory.registerCustomItemBoxRow();
      yield UIExampleFactory.registerReaderTabPanel();
