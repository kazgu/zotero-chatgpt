...
async function startup({ id, version, resourceURI, rootURI }, reason) {
  ...
  if (Zotero.platformMajorVersion >= 102) {
    ...
    chromeHandle = aomStartup.registerChrome(manifestURI, [
      ["content", "zoterochatbot", rootURI + "chrome/content/"],
      ["locale", "zoterochatbot", "en-US", rootURI + "chrome/locale/en-US/"],
      ["locale", "zoterochatbot", "zh-CN", rootURI + "chrome/locale/zh-CN/"],
    ]);
  } else {
